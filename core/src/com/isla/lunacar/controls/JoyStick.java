package com.isla.lunacar.controls;
...
public class JoyStick extends Group {
    ...
    public JoyStick(float minHeight) {
        idle = new Image(MyGdxGame.atlas.findRegion("joystick"));
        addActor(idle);
        ...
        right = new Image(MyGdxGame.atlas.findRegion("joystick_right"));
        right.setSize(getWidth(), getHeight());
        addActor(right);
        left = new Image(MyGdxGame.atlas.findRegion("joystick_left"));
